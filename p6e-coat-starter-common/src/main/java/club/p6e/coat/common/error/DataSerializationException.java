 ...
 * @version 1.0
 */
public class DataSerializationException extends CustomException {
     ...
     * @param content 描述内容
     */
    public DataSerializationException(Class<?> sc, String error, String content) {
     ...
     * @param content   描述内容
     */
    public DataSerializationException(Class<?> sc, Throwable throwable, String content) {
     ...
     * @param content 描述内容
     */
    public DataSerializationException(Class<?> sc, String error, int code, String sketch, String content) {
     ...
     * @param content   描述内容
     */
    public DataSerializationException(Class<?> sc, Throwable throwable, int code, String sketch, String content) {
